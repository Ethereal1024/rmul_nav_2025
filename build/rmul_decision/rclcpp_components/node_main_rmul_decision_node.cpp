...
#define NODE_MAIN_LOGGER_NAME "rmul_decision_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librmul_decision.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<FSMCommander>";
